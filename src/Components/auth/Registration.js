                ...
                <Form onSubmit={this.handleSubmit}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={2}>
                            <FormGroup>
                                <Label style={{padding: "5px"}} for="dateOfBirth">Date of Birth :</Label>
                        ...
                        <Grid item xs={12} sm={6}>
                            <FormGroup>
                                ...
                                <Input type="select" name="country" placeholder="Country" value={this.state.country}
                                       onChange={this.handleChange} required>
                        ...
                        <Grid item xs={12} sm={6}>
                            <FormGroup>
                                {/*<Label for="mpbileNumber">Mobile Number</Label>*/}
